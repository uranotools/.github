...
**La división de software libre de Urano Project**

[![UranoAI](https://img.shields.io/badge/UranoAI-uranoai.com-00D4FF)](https://uranoai.com)
[![GitHub Org](https://img.shields.io/badge/Organización-uranotools-black)](https://github.com/uranotools)
[![Medium](https://img.shields.io/badge/Blog-Medium-12100E)](https://uranoproject.medium.com)
...
## 🛠️ Herramientas Open Source (uranotools)

| Repositorio | Descripción | Estado |
|-------------|-----------|--------|
| [UranoDesktop](https://github.com/uranotools/UranoDesktop) | Aplicación principal y sistema de plugins MCP | Activo |
| [uranocli](https://github.com/uranotools/uranocli) | CLI nativo multi-agente | Activo |
| [ACP-Urano](https://github.com/uranotools/ACP-Urano) | Protocolo anti-alucinaciones | Activo |
| [my-ainewsletter-template](https://github.com/uranotools/my-ainewsletter-template) | Template para newsletter IA autónoma | Activo |
| [my-ainewsletter-plugin](https://github.com/uranotools/my-ainewsletter-plugin) | Plugin de publicación automática | Activo |

---

## 🚀 Crea tu propia newsletter de IA en minutos

Sigue el tutorial completo:

→ **[Cómo Crear Tu Propia Newsletter de IA Personal y Autónoma con Urano Desktop](https://uranoproject.medium.com/c%C3%B3mo-crear-tu-propia-newsletter-de-ia-personal-y-aut%C3%B3noma-con-urano-desktop-45436d24d240)**
...
**Hecho con ❤️ en Guatemala** por Andy E. Gómez y la comunidad Urano Project.

---

*“La IA no debería ser algo que usas. Debería ser algo que posees y controlas.”*